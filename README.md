...
Learn more about http headers [a link](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers)
Learn more about Preflight request [a link](https://developer.mozilla.org/en-US/docs/Glossary/Preflight_request)
```
Middleware function 
